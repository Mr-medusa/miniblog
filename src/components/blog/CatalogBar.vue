                ...
                <ul class="my-catalog">
                    <li v-for="blog in blogList" @click="readBlog(blog)">
                        ...
                        <div class="date-and-tag">
                            <div class="time"><i class="fa fa-calendar" aria-hidden="true"></i><span>{{blog.updateTime}}</span></div>
    ...
    export default {
        ...
        methods:{
            ...
            createBlogAlertOK() {
                ...
                this.$router.push({ name: 'blogArticle', params: {id: newBlog.id, isReadable: false }})
            },
