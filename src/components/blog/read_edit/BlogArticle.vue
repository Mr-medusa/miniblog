        ...
        methods:{
            ...
            deleteBlogAlertOK(){
                if(this.operatorBlog.id >= 0){
                    var myPos = EventHub.blogs.indexOf(this.operatorBlog);
                    this.deletedBlogById(this.operatorBlog.id);
                    var nextBlog = EventHub.blogs[myPos] || EventHub.blogs[myPos - 1];
            ...
            findSearchPage(){
                ...
                if(!this.readOrEdit.blog || this.readOrEdit.blog.id < 0){
                    this.readOrEdit.blog = EventHub.blogs[0];
